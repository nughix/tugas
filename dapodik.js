...
app.post('/data-siswa', isAuthenticated, 
    [
        ...
        body('nisn').custom(async (value) => {
            ...
            return true;
        }).isLength({ min: 8, max: 8 }).withMessage('harus 8 digit angka cuyy').
        ...
        body('nik').custom(async (value) => {
            ...
            return true;
        }).isLength({ min: 8, max: 8 }).withMessage('harus 8 digit angka coyy').
        isNumeric().withMessage('NIK tidak valid!'),

        //? Validasi panjang digit NoKK 
        check('nokk', 'NoKK tidak valid!').isLength({ min: 8, max: 8 }).withMessage('harus 8 digit angka cuyy')
